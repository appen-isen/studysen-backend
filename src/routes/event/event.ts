...
router.post('/', upload.single('image'), async (req, res) => {
  try {
    ...
    const event = await postEvent(title, description, date, location, organizer, imageUrl);
...
router.post('/:event_id/image', upload.single('image'), async (req, res): Promise<void> => {
  try {
...
router.put('/:id', async (req, res) => {
  ...
  const { title, description, date, location, organizer } = req.body;
  try {
    const event = await putEvent(id, title, description, date, location, organizer);
